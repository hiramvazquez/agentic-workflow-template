...
_case_un_timeout_del_sistema_no_relaja_el_limite() {
  ...
  # No es hipotético: en el adoptante iOSAppBaseline el test de arriba pasaba
  # en local y fallaba en su CI de Linux, y ese 1-de-737 le tuvo el Anillo 3
  # rojo DOS DÍAS, diagnosticado como flaky todo ese tiempo (f-1caf51c6).
